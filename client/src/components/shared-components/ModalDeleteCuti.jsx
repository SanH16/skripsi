...
export function ModalDeleteCuti({ closeModal, stateModal }) {
  ...
  const handleOk = async () => {
    try {
      await APIcuti.deleteCuti(stateModal.uuid).then(() => {
        setIsOpen(false);
      ...
      console.error(error);
      showErrorToast("Pengajuan Cuti gagal dihapus", "top-center", "large");
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h5 className="font-bold">Menghapus Data Cuti</h5>
        <p
          id="logout-modal-text"
