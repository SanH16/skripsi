...
export function ModalDeletePunishment({
  closeModal,
  stateModal,
  refetchDelete,
}) {
  ...
  const handleOk = async () => {
    try {
      await APIpunishment.deletePunishment(stateModal.uuid).then(() => {
        setIsOpen(false);
      ...
      console.error(error);
      showErrorToast("Data Punishment gagal dihapus", "top-center", "large");
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h5 className="font-bold">Menghapus Data Punishment</h5>
        <p
          id="logout-modal-text"
